...
class FiniteField:
    ...
    @staticmethod
    def get_byte_string_from_coeffs(coeffs):
        str_a = ''
    ...
    # which belongs to GF(256) and multiplied by the first element equals to 1 = 0*X^8+0*X^7+0*X^6 ... +0*X^1+1
    ...
    def __mod__(self, other):
        ...
        while diff >= 0:
            ...
            mul = self.mul(other.get_byte(), FiniteField.get_byte_string_from_coeffs(coeffs))
